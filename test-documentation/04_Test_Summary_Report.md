...
This report summarizes the results of manual functional testing performed on the ParaBank Demo application.

A total of **45 test cases** were executed in TestRail, covering login, registration, accounts, fund transfers, bill payments, profile management and session handling.
...
A total of **8 defects** were identified during testing.
...
Detailed defect reports are available in the [Bug Reports](../bug-reports/) folder.

## Conclusion

Most of the tested functionality worked as expected, with **36 of 45 test cases passing**.

Issues were found mainly in:
...
One test case was blocked because it depended on the profile update functionality that failed during testing.

The identified defects should be fixed and retested, followed by regression testing of the affected areas.
